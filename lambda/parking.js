...
exports.handler = (event, context, callback) => {
    ...
    const area = findArea(pickupLocation);
...
function findArea(pickupLocation) {
    console.log('Finding area for ', pickupLocation.Latitude, ', ', pickupLocation.Longitude);
    return 1;
}

function findParking(username, area) {
    var params = {
      TableName: 'miye-table1'
    };
